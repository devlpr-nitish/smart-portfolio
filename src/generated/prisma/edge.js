...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/devlprnitish/Desktop/Projects/smartportfolio/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/devlprnitish/Desktop/Projects/smartportfolio/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://devlprnitish:nitish440db@localhost:5433/portfoliodb"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "b92d5003489d1828f048383b80679a0796fe0ca052e0e44514e07fe3eb58db18",
  "copyEngine": true
}
config.dirname = '/'
