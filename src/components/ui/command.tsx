...
const CommandDialog = ({ children, ...props }: DialogProps) => {
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden p-0 sm:max-w-lg [&>button:last-child]:hidden">
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-input px-5 bg-[#050505]/60" cmdk-input-wrapper="">
