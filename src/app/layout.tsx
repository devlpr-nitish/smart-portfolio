  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${bangers.variable}`}>
      ...
      <body className="bg-[#050505] relative">
        ...
        <nav className="fixed md:bottom-4 md:right-84 bottom-5 -right-32 transform -translate-x-1/2 z-50 bg-[#050505]/90 backdrop-blur-md rounded-full shadow-lg border border-white/10">
          <Navbar />
        </nav>
